...
public class MyMatrixDebugger : EditorWindow
{
    public GameObject target;
    GUIStyle style = new GUIStyle();
    [MenuItem("Window/MyMatrixDebugger")]
    static void Init()
    {
        MyMatrixDebugger window = (MyMatrixDebugger)EditorWindow.GetWindow(typeof(MyMatrixDebugger));
        window.Show();
    }
